...
public class VerwaltungUI extends VerticalLayout {
    ...
    private void configureGrid() {
        ...
        grid.addColumn(bewerber -> bewerber.getArbeitszeit().getName()).setHeader("Arbeitszeit");
        grid.addColumn(bewerber -> bewerber.getBewerberStatus().getName()).setHeader("Bewerberstatus");
